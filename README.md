...
Portfolio case study: [**docs/AGRO_CASE_STUDY_EN.md**](docs/AGRO_CASE_STUDY_EN.md) · Russian twin: [grounded-horticulture_ru](https://github.com/kantik001/grounded-horticulture_ru)
