...
**Repository:** [grounded_horticulture_en](https://github.com/kantik001/grounded_horticulture_en) — public portfolio (code + demo data); full journal corpus not in git. RU: [grounded-horticulture_ru](https://github.com/kantik001/grounded-horticulture_ru).
