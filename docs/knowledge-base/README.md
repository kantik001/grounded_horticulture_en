...
3. Product roadmap → [`../ROADMAP.md`](../ROADMAP.md).
4. Pilot / demo readiness → [`../PILOT_READINESS_AUDIT.md`](../PILOT_READINESS_AUDIT.md), [`../AGRO_CASE_STUDY_RU.md`](../AGRO_CASE_STUDY_RU.md), [`../DATA_LICENSE.md`](../DATA_LICENSE.md).
